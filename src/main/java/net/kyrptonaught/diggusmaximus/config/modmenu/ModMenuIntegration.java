    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return (screen) -> {
           ...
           mainSection.addConfigItem(new FloatItem(new TranslatableText("key.diggusmaximus.config.exhaustionmultiplier"), options.exhaustionMultiplier,1.0f).setSaveConsumer(val -> options.exhaustionMultiplier = val));
            ...
            shapeSection.addConfigItem(new KeybindItem(new TranslatableText("key.diggusmaximus.config.shapekey"), shapes.shapeKey, "").setSaveConsumer(val -> shapes.shapeKey = val));
            shapeSection.addConfigItem(new KeybindItem(new TranslatableText("key.diggusmaximus.config.cyclekey"), shapes.cycleKey, "").setSaveConsumer(val -> shapes.cycleKey = val));
